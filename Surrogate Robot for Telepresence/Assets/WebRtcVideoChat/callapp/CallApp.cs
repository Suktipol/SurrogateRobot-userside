...
public class CallApp : MonoBehaviour
{
    ...
    /// method.
    /// </summary>
    public string uIceServer = "numb.viagenie.ca";

    //
    public string uIceServerUser = "suktipol.kia@gmail.com";
    public string uIceServerPassword = "teng@f1bo";
    ...
    protected virtual void Call_CallEvent(object sender, CallEventArgs e)
    {
        switch (e.Type)
        {
            case CallEventType.CallAccepted:
                ...
                SceneManager.startButtonState = "CONNECTED";
            ...
            case CallEventType.CallEnded:
                ...
                SceneManager.startButtonState = "IDLE";
                Append("Call ended");
                InternalResetCall();
                break;
